...
function () {
  ...
  /**
   * @function set - update and trigger change
   * @param update
   */
  ...
  Model.prototype.set = function (update) {
    ...
    this.events.trigger('change'); // after updating trigger `change` event
  };
...
function () {
  function Attributes(data) {
    ...
    this.data = data; // The return type is going to be a lookup on type T for the given key
...
function (_super) {
  ...
  /**
   * @function buildUser - using Composition to initialize sub-modules that will be used in Model
   * @param attrs -
   *
   * @function buildUserCollection - Main Initiator of Users fetched from database
   */
