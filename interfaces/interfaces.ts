...
// This means as long as your data structure satisfies a contract, TypeScript will allow it. Even if you have too many keys declared.
...
// MODULE: Hybrid Types, TypeScript allows interfaces to represent hybrid types, i.e. interfaces can have combination of properties, function declarations, indexer and methods. This flexibility is allowed to get aligned with JavaScript dynamic nature.
interface Counter {
  (start: number): string // function declaration
  interval: number // property
  reset(): void // method
  [status: string]: any // indexer
}
